...
export const PARYS_DERIVATION_PATH = "m/44'/52752'/0'/0"
...
export const PARYS_LEDGER_APP_MIN_VERSION = '1.7.1' // Only allow this ledger app versions or newer
...
export const WEI_PER_UNIT = '1000000000000000000' // 1 PARYS or Ether
...
export const MIN_LOCK_AMOUNT = '10000000000000000' // 0.01 PARYS
export const MIN_LOCKED_GOLD_TO_VOTE = '100000000000000000' // 0.1 PARYS
export const MIN_VOTE_AMOUNT = '10000000000000000' // 0.01 PARYS
export const MAX_NUM_ELECTABLE_VALIDATORS = 100
export const BARCHART_MIN_SHOW_AMOUNT = '1000000000000000' // 0.001 PARYS
...
export const GOVERNANCE_GITHUB_BASEURL =
  'https://api.github.com/repos/parys-org/governance/contents/CGPs/'
