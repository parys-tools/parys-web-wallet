...
export function GovernanceFormScreen() {
  ...
  const helpText = `You have ${
    hasLocked ? 'almost ' : ''
  } no locked PARYS. You must lock some before voting. Your locked amount determines your vote weight.`
  ...
  return (
    <>
      ...
      <div css={style.proposalTip}>
        For past proposals, see <TextLink link="https://parys.stake.id">parys.stake.id</TextLink> or{' '}
        <TextLink link="https://theparys.com">theparys.com</TextLink>
      </div>
    </>
  )
}
