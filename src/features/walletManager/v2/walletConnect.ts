...
import type { ClientTypes, SessionTypes } from '@walletconnectv2/types'
import { ERROR as WcError, Error as WcErrorType } from '@walletconnectv2/utils'
...
import {
  ...
  SUPPORTED_CHAINS,
} from 'src/features/walletManager/config'
import {
  handleWalletConnectRequest,
  validateRequestEvent,
} from 'src/features/walletManager/requestHandler'
import {
  SessionStatus,
  WalletConnectError,
  WalletConnectMethod,
