...
// Ethers uses slightly different tx field names than web3 / parys sdk
export function translateTxFields(tx: PARYSTransactionRequest & { gas?: BigNumberish }) {
...
export function isValidTx(tx: PARYSTransactionRequest & { gas?: BigNumberish }) {
  try {
