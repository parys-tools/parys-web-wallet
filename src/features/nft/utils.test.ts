...
describe('Formats IPFS Urls', () => {
  it('Formats valid https urls', () => {
    ...
    expect(
      formatIpfsUrl(
        'https://womxnofparys.mypinata.cloud/ipfs/QmWQrQrDpTyLWk76qZwNYf4NQSSmKsCRSeVKuH4oAMJa25/710.json'
      )
    ).toEqual(
    ...
    expect(formatIpfsUrl('https://womxnofparys.mypinata.cloud/ipfs/ABC1230912390/123.png')).toEqual(
      'https://cloudflare-ipfs.com/ipfs/ABC1230912390/123.png'
    )

    expect(formatIpfsUrl('https://womxnofparys.mypinata.cloud/ipfs/0/0.svg')).toEqual(
