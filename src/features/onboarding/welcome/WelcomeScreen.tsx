    ...
    <Box direction="column" justify="between" align="center" styles={style.frame}>
      ...
      <main>
        <Box direction="column" justify="center" align="center">
          <img width="200rem" height="200rem" src={Logo} alt="PARYS Logo" css={style.logo} />
          <h1 css={style.h1}>{`A ${isMobile ? '' : 'simple '}wallet for the PARYS network`}</h1>
          <h2 css={style.h2}>Manage your Carbon and Crypto investments!</h2>
