...
function getContentByTxType(tx: PARYSTransaction, tokens: TokenMap) {
  ...
  if (
    tx.type === TransactionType.ValidatorVotePARYS ||
    tx.type === TransactionType.ValidatorActivatePARYS ||
...
function TransactionAdvancedDetails({ tx }: { tx: PARYSTransaction }) {
