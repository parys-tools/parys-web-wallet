...
export function DomainResolverStatus({
  ...
  const onClickNullAddressError = () => {
    showModal({
      ...
      body: 'Note: for Nomspace, default addresses are retrieved. For Unstoppable and ENS, only PARYS-specific address records are used.',
      size: 's',
    })
  }
  ...
  const onClickGenericError = () => {
    showModal({
      ...
      body: 'PARYS Wallet was unable to retrieve the name records. Check that the wallet is connected and that a valid name was provided.',
      size: 's',
    })
  }
