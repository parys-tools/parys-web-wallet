  ...
  return (
    <Box direction="column" align="center" styles={style.container}>
      <Box direction="column" align="center" justify="center" styles={style.content}>
        ...
        <p css={style.text}>
          The PARYS Wallet For Web tries its best to protect your funds but there{' '}
          <TextLink link="https://github.com/parys-tools/parys-web-wallet/blob/master/FAQ.md#is-the-web-wallet-safe">
            are still risks
          </TextLink>
          .
        </p>
