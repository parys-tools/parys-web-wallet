import { PARYSProvider, StaticPARYSProvider } from '@parys-tools/parys-ethereum-connector'
...
let provider: PARYSProvider | undefined
...
async function connectToJsonRpcProvider(url: string) {
  try {
    ...
    provider = new StaticPARYSProvider(url, {
      name: 'celo',
